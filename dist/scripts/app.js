            ...
            React.createElement("div", {id: "question"}, 
                ...
                React.createElement("div", {className: "col-md-9"}, 
                  React.createElement("div", {id: "output"}, 
                      ...
                      React.createElement("div", {className: "row"}, 
                          React.createElement("div", {className: "col-md-3 col-md-offset-5"}, 
                              React.createElement("input", {className: "form-control", id: "expected-output", placeholder: "Expected Output: " + this.props.question_data.test_data.output, readOnly: true})
                          ), 
                          React.createElement("div", {className: "col-md-3 col-mod-offset-6", id: "opponent"}, 
                              React.createElement("input", {className: "form-control", id: "opponent-output", placeholder: "Opponent Output: " + this.props.opponentOutput, readOnly: true})
                          )
                      ), 
                      React.createElement("div", {className: "row"}, 
                          React.createElement("div", {className: "col-md-6 col-md-offset-5"}, 
...
var Boilerplate = React.createClass({displayName: "Boilerplate",
    render: function() {
        return (
            React.createElement("div", {id: "boilerplate"}, 
                React.createElement("p", null, " ", this.props.boilerplate, " ")
            )
        );
    }
    ...
    if(this.props.hidden)
      ...
      return (
        React.createElement("div", null, 
          ...
          React.createElement("div", {className: "row"}, 
            React.createElement("div", {className: "welcomeBody col-md-offset-2 col-md-8"}, "You have arrived at OneLiner! This is a live coding competition where you need to out-program another person live via one line return statements. JavaScript is your weapon, solve wisely my friends.")
          ), 
          React.createElement("div", {className: "row"}, 
            React.createElement("div", {className: "welcomeBody col-md-offset-2 col-md-8"}, "Awaiting match")
          ), 
          React.createElement("div", {className: "row"}, 
            React.createElement("img", {className: "spinWait", src: "https://apps.nea.gov/grantsearch/images/ajaxSpinner.gif", alt: "Waiting spinner"})
          )
        )
      )
...
React.render(React.createElement(OneLinerApp, null), mountNode);
